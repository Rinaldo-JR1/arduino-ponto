/*
  ...
  - You are about to drop the column `timeIn` on the `DailyRegister` table. All the data in the column will be lost.
  - You are about to drop the column `timeOut` on the `DailyRegister` table. All the data in the column will be lost.
  - Added the required column `registerType` to the `DailyRegister` table without a default value. This is not possible if the table is not empty.
